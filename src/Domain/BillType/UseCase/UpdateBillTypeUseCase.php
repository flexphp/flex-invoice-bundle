...
use FlexPHP\Bundle\InvoiceBundle\Domain\BillType\Response\UpdateBillTypeResponse;

final class UpdateBillTypeUseCase
{
    ...
    public function execute(UpdateBillTypeRequest $request): UpdateBillTypeResponse
    {
        return new UpdateBillTypeResponse($this->billTypeRepository->change($request));
    }
}
