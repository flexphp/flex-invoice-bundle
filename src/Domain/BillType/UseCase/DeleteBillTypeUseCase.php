...
use FlexPHP\Bundle\InvoiceBundle\Domain\BillType\Response\DeleteBillTypeResponse;

final class DeleteBillTypeUseCase
{
    ...
    public function execute(DeleteBillTypeRequest $request): DeleteBillTypeResponse
    {
        return new DeleteBillTypeResponse($this->billTypeRepository->remove($request));
    }
}
