...
use FlexPHP\Bundle\InvoiceBundle\Domain\Bill\Response\DeleteBillResponse;
...
final class DeleteBillUseCase
{
    ...
    public function execute(DeleteBillRequest $request): DeleteBillResponse
    {
        return new DeleteBillResponse($this->billRepository->remove($request));
    }
}
